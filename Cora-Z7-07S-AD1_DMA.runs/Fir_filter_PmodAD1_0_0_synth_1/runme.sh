...
HD_PWD='C:/Projects/ERN24004/Projects/Cora-Z7-07S-AD1_DMA/Cora-Z7-07S-AD1_DMA.runs/Fir_filter_PmodAD1_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Fir_filter_PmodAD1_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Fir_filter_PmodAD1_0_0.tcl
